...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistDashboardEditBook() {
		...
		$( document ).on( 'click', '.wpbooklist-admin-editbook-edit-button', function( event ) {
			...
			if ( window.location.href.endsWith( '?page=WPBookList-Options-books&tab=edit-books' ) ) {
	...
	function wpbooklistSaveBookViewDisplayOptions() {
		...
		$( '.wpbooklist-admin-save-book-display-button' ).click( function( event ) {
			...
			//"--tester1;Plain Text Entry;No;Yes;NA--tester2;Text Link;No;Yes;NA--tester3;Image Link;No;Yes;NA--tester4;Drop-Down;No;Yes;tester4option1/tester4option2--tester5;Paragraph;No;Yes;NA"
