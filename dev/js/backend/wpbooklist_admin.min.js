...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistEnableSelect2() {
		console.log('fdsjhfhdsjfhdjskfhdsjkfhjdsk')
	...
	function wpbooklistAddBookValidator() {
		...
		var useAmazonYes = $( 'input[name="use-amazon-yes"]' );
		var useAmazonNo = $( 'input[name="use-amazon-no"]' );
		var isbn10 = $( '#wpbooklist-addbook-isbn10' ).val();
		var isbn13 = $( '#wpbooklist-addbook-isbn13' ).val();
		var asin = $( '#wpbooklist-addbook-asin' ).val();
		var titleVal = $( '#wpbooklist-addbook-title' ).val();
	...
	function wpbooklistDashboardEditBook() {
		...
		$( document ).on( 'click', '#wpbooklist-admin-addbook-create-button', function( event ) {
...
console.log(bookInfo)
					...
					if ( -1 < bookInfo.subgenre.indexOf( '---' ) ) {
					...
					if ( -1 < bookInfo.similarbooks.indexOf( '---' ) ) {
					...
					if ( -1 < bookInfo.othereditions.indexOf( '---' ) ) {
					...
					// Populating the 'Other Editions' area
					if ( -1 < bookInfo.keywords.indexOf( '---' ) ) {
							...
							if ( response[0] == 1 ) {
								...
								if ( useAmazonYes ) {
									if ( amazonapifailcount == 2 || amazonapifailcount == '2' ) {
										var editbookSuccess1 = '<p><span id="wpbooklist-success-span">' + wpbooklistPhpVariables.trans49 + '</span><br/> ' + wpbooklistPhpVariables.trans87 + "<em> " + wpbooklistPhpVariables.trans51 + ' </em>' + wpbooklistPhpVariables.trans52;
									} else {
										var editbookSuccess1 = '<p><span id="wpbooklist-success-span">' + wpbooklistPhpVariables.trans38 + "</span><br/>&nbsp;" + wpbooklistPhpVariables.trans83 + ":&nbsp;<span id='wpbooklist-editbook-success-shortcode'>"; 
									}
								} else {
									var editbookSuccess1 = '<p><span id="wpbooklist-success-span">' + wpbooklistPhpVariables.trans38 + "</span><br/>&nbsp;" + wpbooklistPhpVariables.trans83 + "&nbsp;<span id='wpbooklist-editbook-success-shortcode'>"; 
								}
