...
jQuery( document ).ready( function( $ ) {
	...
	// Function to add any existing Custom Fields to the final JS Object that is sent to class-book.php to save/edit a book.
			...
			for ( var i = 0; i < customFieldsArray.length; i++ ) {
				if ( -1 < customFieldsArray[i].indexOf( ';' ) ) {
					...
					if ( 'plain-text-entry' === type ) {
						...
						val = $( 'input[name="book-customfield-' + indivCustomField[0] + '"]' ).prop( 'checked' );
					...
					if ( 'text-link' === type ) {
						...
						val = $( 'input[name="book-customfield-textlink-text-' + indivCustomField[0] + '"]' ).val() + '---'  +  $( 'input[name="book-customfield-textlink-link-' + indivCustomField[0] + '"]' ).prop( 'checked' );
						data[ indivCustomField[0] ] = val;
					}
					...
					if ( 'drop-down' === type ) {
						...
						val = $( '#wpbooklist-customfield-dropdown-' + indivCustomField[0] ).prop( 'checked' );
						data[ indivCustomField[0] ] = val;
					}

					// Adding all the Image Link Fields to the Data object.
					if ( 'image-link' === type ) {
						val = $( 'input[name="book-customfield-imagelink-image-' + indivCustomField[0] + '"]' ).val() + '---'  +  $( 'input[name="book-customfield-imagelink-text-' + indivCustomField[0] + '"]' ).prop( 'checked' );
						data[ indivCustomField[0] ] = val;
					}
					...
					if ( 'paragraph' === type ) {
						...
						val = $( '#wpbooklist-customfield-textarea-' + indivCustomField[0] ).prop( 'checked' );
						data[ indivCustomField[0] ] = val;
					}
				}
			}
	...
	function wpbooklistDashboardAddBook() {
		...
		$( '#wpbooklist-admin-addbook-create-button' ).on( 'click', function() {
			...
			var additionalimage1 = $( 'input[name="book-additionalimage1"]' ).prop( 'checked' );
			var additionalimage2 = $( 'input[name="book-additionalimage2"]' ).prop( 'checked' );
			var amazonauth = $( 'input[name="authorize-amazon-yes"]' ).prop( 'checked' );
			var amazondetailpage = $( 'input[name="book-amazonlink"]' ).prop( 'checked' );
			var appleibookslink = $( 'input[name="book-ibookslink"]' ).prop( 'checked' );
			var asin = $( 'input[name="book-asin"]' ).prop( 'checked' );
			var author = $( 'input[name="book-author1"]' ).prop( 'checked' );
			var author2 = $( 'input[name="book-author2"]' ).prop( 'checked' );
			var author3 = $( 'input[name="book-author3"]' ).prop( 'checked' );
			var authorurl = $( 'input[name="book-authorlink"]' ).prop( 'checked' );
			var backcover = $( 'input[name="book-backcover"]' ).prop( 'checked' );
			var bnlink = $( 'input[name="book-bnlink"]' ).prop( 'checked' );
			var bamlink = $( 'input[name="book-bamlink"]' ).prop( 'checked' );
			var callnumber = $( 'input[name="book-callnumber"]' ).prop( 'checked' );
			var category = $( 'input[name="book-genre"]' ).prop( 'checked' );
			var copies = $( 'input[name="book-lend-copies"]' ).prop( 'checked' );
			var country = $( 'input[name="book-country"]' ).prop( 'checked' );
			var crosssells = $( '#select2-crosssells' ).prop( 'checked' );
			var datefinished = $( 'input[name="book-date-finished-text"]' ).prop( 'checked' );
			var description = $( 'textarea[name="book-fulldescription"]' ).prop( 'checked' );
			var download = $( 'input[name="wpbooklist-woocommerce-download-yes"]' ).prop( 'checked' );
			var edition = $( 'input[name="book-edition"]' ).prop( 'checked' );
			var finished = $( '#wpbooklist-addbook-select-finished' ).prop( 'checked' );
			var firstedition = $( 'input[name="book-firstedition-yes"]' ).prop( 'checked' );
			var format = $( 'input[name="book-format"]' ).prop( 'checked' );
			var genres = $( '#wpbooklist-addbook-select-genres' ).prop( 'checked' );
			var goodreadslink = $( 'input[name="book-goodreadslink"]' ).prop( 'checked' );
			var googlepreview = $( 'input[name="book-googlepreview"]' ).prop( 'checked' );
			var height = $( 'input[name="book-woo-height"]' ).prop( 'checked' );
			var illustrator = $( 'input[name="book-illustrator"]' ).prop( 'checked' );
			var image = $( 'input[name="book-image"]' ).prop( 'checked' );
			var isbn = $( 'input[name="book-isbn10"]' ).prop( 'checked' );
			var isbn13 = $( 'input[name="book-isbn13"]' ).prop( 'checked' );
			var keywords = $( '#wpbooklist-addbook-select-keywords' ).prop( 'checked' );
			var kobolink = $( 'input[name="book-kobolink"]' ).prop( 'checked' );
			var language = $( 'input[name="book-language"]' ).prop( 'checked' );
			var length = $( 'input[name="book-woo-length"]' ).prop( 'checked' );
			var library = $( '#wpbooklist-addbook-select-library' ).prop( 'checked' );
			var notes = $( 'textarea[name="book-notes"]' ).prop( 'checked' );
			var numberinseries = $( 'input[name="book-numberinseries"]' ).prop( 'checked' );
			var originalpubyear = $( 'input[name="book-originalpublicationyear"]' ).prop( 'checked' );
			var originaltitle = $( 'input[name="book-originaltitle"]' ).prop( 'checked' );
			var othereditions = $( '#wpbooklist-addbook-select-othereditions' ).prop( 'checked' );
			var outofprint = $( '#wpbooklist-addbook-select-outofprint' ).prop( 'checked' );
			var pages = $( 'input[name="book-pages"]' ).prop( 'checked' );
			var pageyes = $( '#wpbooklist-addbook-select-createpage' ).prop( 'checked' );
			var postyes = $( '#wpbooklist-addbook-select-createpost' ).prop( 'checked' );
			var price = $( 'input[name="book-price"]' ).prop( 'checked' );
			var productcategory = $( '#wpbooklist-woocommerce-category-select' ).prop( 'checked' );
			var publisher = $( 'input[name="book-publisher"]' ).prop( 'checked' );
			var pubyear = $( 'input[name="book-publicationyear"]' ).prop( 'checked' );
			var purchasenote = $( '#wpbooklist-addbook-woo-note' ).prop( 'checked' );
			var rating = $( '#wpbooklist-addbook-select-book-rating' ).prop( 'checked' );
			var regularPrice = $( 'input[name="book-woo-regular-price"]' ).prop( 'checked' );
			var reviews = $( '#wpbooklist-woocommerce-review-yes' ).prop( 'checked' );
			var salebegin = $( '#wpbooklist-addbook-woo-salebegin' ).prop( 'checked' );
			var saleend = $( '#wpbooklist-addbook-woo-saleend' ).prop( 'checked' );
			var saleprice = $( 'input[name="book-woo-sale-price"]' ).prop( 'checked' );
			var series = $( 'input[name="book-series"]' ).prop( 'checked' );
			var shortdescription = $( '#wpbooklist-addbook-shortdescription' ).prop( 'checked' );
			var signed = $( '#wpbooklist-addbook-select-signed' ).prop( 'checked' );
			var similarbooks = $( '#wpbooklist-addbook-select-similarbooks' ).prop( 'checked' );
			var sku = $( '#wpbooklist-addbook-woo-sku' ).prop( 'checked' );
			var stock = $( 'input[name="book-woo-stock"]' ).prop( 'checked' );
			var subgenres = $( '#wpbooklist-addbook-select-subgenres' ).prop( 'checked' );
			var subject = $( 'input[name="book-subject"]' ).prop( 'checked' );
			var swapyes = $( 'input[name="book-bookswapper-yes"]' ).prop( 'checked' );
			var title = $( 'input[name="book-title"]' ).prop( 'checked' );
			var upsells = $( '#select2-upsells' ).prop( 'checked' );
			...
			var weight = $( 'input[name="book-woo-weight"]' ).prop( 'checked' );
			var width = $( 'input[name="book-woo-width"]' ).prop( 'checked' );
	...
	function wpbooklistDashboardEditBook() {
		...
		$( document ).on( 'click', '.wpbooklist-admin-editbook-edit-button', function( event ) {
			...
			var language = $( 'input[name="book-language"]' ).prop( 'checked' );
			var length = $( 'input[name="book-woo-length"]' ).prop( 'checked' );
			var library = $( '#wpbooklist-editbook-select-library' ).prop( 'checked' );
			var notes = $( 'textarea[name="book-notes"]' ).prop( 'checked' );
			var numberinseries = $( 'input[name="book-numberinseries"]' ).prop( 'checked' );
			var originalpubyear = $( 'input[name="book-originalpublicationyear"]' ).prop( 'checked' );
			var originaltitle = $( 'input[name="book-originaltitle"]' ).prop( 'checked' );
			...
			var subject = $( 'input[name="book-subject"]' ).prop( 'checked' );
			var swapyes = $( 'input[name="book-bookswapper-yes"]' ).prop( 'checked' );
			var title = $( 'input[name="book-booktitle"]' ).prop( 'checked' );
			var upsells = $( '#select2-upsells' ).prop( 'checked' );
			var useAmazonYes = $( 'input[name="use-amazon-yes"]' ).prop( 'checked' );
			var virtual = $( 'input[name="wpbooklist-woocommerce-vert-yes"]' ).prop( 'checked' );
			var weight = $( 'input[name="book-woo-weight"]' ).prop( 'checked' );
	...
	function wpbooklistCreateNewLibraryDisableAndClear() {
		...
		$( '.wpbooklist-dynamic-input' ).on( 'click', function() {
			var currentVal = $( '.wpbooklist-dynamic-input' ).prop( 'checked' );
		...
		$( document ).on( 'click', '.wpbooklist-edit-actions-edit-button', function( event ) {
			...
			request = $.ajax({
				...
				success: function( response ) {
					...
					library = $( '#wpbooklist-editbook-select-library' ).prop( 'checked' );
...
console.log(bookInfo)
					...
					// Populating the 'Create' Page and Post Drop-Downs.
					...
					} else if ( wpbooklistPhpVariables.trans131 === bookInfo.page_yes || 'true' === bookInfo.page_yes ) {
						$( '#wpbooklist-addbook-select-createpage' ).val( wpbooklistPhpVariables.trans131 );
					} else {
						$( '#wpbooklist-addbook-select-createpage' ).val( wpbooklistPhpVariables.trans221 );
					}

					// Populating the 'Create' post and Post Drop-Downs.
					...
					} else if ( wpbooklistPhpVariables.trans131 === bookInfo.post_yes || 'true' === bookInfo.post_yes ) {
						$( '#wpbooklist-addbook-select-createpost' ).val( wpbooklistPhpVariables.trans131 );
					} else {
	...
	function wpbooklistEditBookSearch() {
		$( document ).on( 'click', '#wpbooklist-edit-book-search-button', function( event ) {
					...
					var searchTerm = $( '#wpbooklist-edit-book-search-input' ).prop( 'checked' );
	...
	function wpbooklistUserApis() {
		$( '#wpbooklist-save-api-settings' ).click( function( event ) {
					...
					var amazonapipublic = $( '#wpbooklist-amazon-api-public' ).prop( 'checked' );
					var amazonapisecret = $( '#wpbooklist-amazon-api-secret' ).prop( 'checked' );
					var googleapi = $( '#wpbooklist-google-api' ).prop( 'checked' );
	...
	function wpbooklistAssignStylepak() {		
		// Actually assigning a StylePak to a library
				$( document ).on( 'click', '#wpbooklist-apply-library-stylepak', function( event ) {
					var stylePak = $( '#wpbooklist-select-library-stylepak' ).prop( 'checked' );
					var library = $( '#wpbooklist-stylepak-select-library' ).prop( 'checked' );
	...
	function wpbooklistAssignPostTemplate() {
		$( document ).on( 'click', '#wpbooklist-apply-post-template', function( event ) {
					var template = $( '#wpbooklist-select-post-template' ).prop( 'checked' );
	...
	function wpbooklistAssignPageTemplate() {
		$( document ).on( 'click', '#wpbooklist-apply-page-template', function( event ) {
					var template = $( '#wpbooklist-select-page-template' ).prop( 'checked' );
	...
	function wpbooklistCreateDbLibraryBackup() {
		...
		$( document ).on( 'click', '#wpbooklist-apply-library-backup', function( event ) {
			...
			var library = $( '#wpbooklist-backup-select-library' ).prop( 'checked' );
			...
			var request = $.ajax({
				...
				success: function( response ) {
					...
					$( '#wpbooklist-addbackup-success-div' ).html( "<span id='wpbooklist-success-span'>" + wpbooklistPhpVariables.trans38 + "</span><br/><br/> " + wpbooklistPhpVariables.trans97 + " <a href='" + wpbooklistPhpVariables.LIBRARY_DB_BACKUPS_UPLOAD_URL + response[1] + ".zip'>" + wpbooklistPhpVariables.trans98 + ".</a><div id='wpbooklist-addstylepak-success-thanks'>" + wpbooklistPhpVariables.trans43 + " <a href='http://wpbooklist.com/index.php/extensions/'>" + wpbooklistPhpVariables.trans44 + "</a><br/><br/> " + wpbooklistPhpVariables.trans45 + " <a id='wpbooklist-addbook-success-review-link' href='https://wordpress.org/support/plugin/wpbooklist/reviews/?filter=5'>" + wpbooklistPhpVariables.trans46 + "</a><img id='wpbooklist-smile-icon-1' src='" + wpbooklistPhpVariables.ROOT_IMG_ICONS_URL + "happy.svg'></div>" );
	...
	function wpbooklistRestoreDbLibraryBackup() {
		$( document ).on( 'click', '#wpbooklist-apply-library-restore', function( event ) {
			...
			var table = $( '#wpbooklist-select-library-backup' ).prop( 'checked' );
			var backup = $( '#wpbooklist-select-actual-backup' ).prop( 'checked' );
	...
	function wpbooklistCreateCsv() {
		$( document ).on( 'click', '#wpbooklist-apply-library-backup-csv', function( event ) {
					...
					var table = $( '#wpbooklist-backup-csv-select-library' ).prop( 'checked' );
	...
	function wpbooklistStorytimeSelectCategory() {
		$( document ).on( 'change', '#wpbooklist-storytime-category-select', function( event ) {
					...
					var category = $( this ).prop( 'checked' );
