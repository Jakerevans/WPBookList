...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistInitialAmazonAuthCheck() {
		...
		if ( true === amazonAuthYes.prop( 'checked' ) ) {
	...
	function wpbooklistAddBookValidator() {
		...
		if ( false === amazonAuthYes.prop ( 'checked' ) && false === amazonAuthNo.prop ( 'checked' ) ) {
		...
		// If the Amazon Auth and Use Amazon options are checked, but no ISBN10/13 and/or ASIN number(s) was/were provided.
		if ( true === useAmazonYes.prop ( 'checked' ) && true === amazonAuthYes.prop ( 'checked' ) && '' === isbn10 && '' === isbn13 && '' === asin ) {
	...
	function wpbooklistDashboardAddBook() {
		...
		$( '#wpbooklist-admin-addbook-create-button' ).click( function( event ) {
					...
					request = $.ajax({
						...
						success: function( response ) {
							...
							if ( '1' === response[0]) {
								...
								successDiv.html( '<p class="wpbooklist-tab-intro-para">' + wpbooklistPhpVariables.trans47 + ' <a href="mailto: techsupport@wpbooklist.com">' + wpbooklistPhpVariables.trans48 + '</a><br/><br/>' + response[1] + '</p>' );
								$( '#wpbooklist-spinner-1' ).animate({ 'opacity': '0'}, 500 );
								$( '#wpbooklist-success-1' ).animate({ 'opacity': '1'}, 500 );
							}
						},
