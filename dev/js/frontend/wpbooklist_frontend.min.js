...
jQuery( document ).ready( function( $ ) {
	...
	function wpbooklistReadMorePosts() {
		...
		// Enables the 'Read More' link for the description block in a post utilizing the readmore.js file
		$( '.wpbl-list-book-description-contents' ).readmore({
			speed: 175,
			heightMargin: 16,
			collapsedHeight: 60,
			moreLink: '<a class="wpbl-list-book-description-readmorelesslink" href="#">Read more</a>',
			lessLink: '<a class="wpbl-list-book-description-readmorelesslink" href="#">Read less</a>'
		});
