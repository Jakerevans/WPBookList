...
function wpbooklist_jquery_readmore_js() {
  if(!wp_script_is('wpbooklist_jquery_readmore_js') && !wp_script_is('wpgamelist_jquery_readmore_js')){
    wp_register_script('wpbooklist_jquery_readmore_js', JAVASCRIPT_URL.'jquery-readmore/readmore.min.js', array('jquery'), false, true);
    wp_enqueue_script('wpbooklist_jquery_readmore_js', JAVASCRIPT_URL.'jquery-readmore/readmore.min.js', array('jquery'), false, true);
  }
}
  ...
  if(is_admin()){
    if(stripos($hook, 'WPBookList-Options') !== false){
      ...
      if(!wp_script_is('colorboxjsforwpgamelist') && !wp_script_is('colorboxjsforwpbooklist')){
        wp_register_script( 'colorboxjsforwpbooklist', JAVASCRIPT_URL.'jquery-colorbox/jquery.colorbox-min.js', array('jquery'), false, true);
        wp_enqueue_script('colorboxjsforwpbooklist', JAVASCRIPT_URL.'jquery-colorbox/jquery.colorbox-min.js', array('jquery'), false, true);
      }
    }
  } else {
    global $wpdb;
  ...
  if(is_admin()){
    if(stripos($hook, 'WPBookList-Options') !== false){
      if(!wp_script_is('addthisjsforwpgamelist') && !wp_script_is('addthisjsforwpbooklist')){
        wp_register_script( 'addthisjsforwpbooklist', JAVASCRIPT_URL.'jquery-addthis/addthis.js', array('jquery'), false, true);
        wp_enqueue_script('addthisjsforwpbooklist', JAVASCRIPT_URL.'jquery-addthis/addthis.js', array('jquery'), false, true);
      }
    }
  } else {
    global $wpdb;
