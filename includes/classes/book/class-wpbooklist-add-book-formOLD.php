		...
		public function output_add_book_form() {
			...
			wp_enqueue_media();
		 	$string1 = "<div id='wpbooklist-addbook-container'>
					<p>" . $this->trans->trans_74 . "<span class='wpbooklist-color-orange-italic'> ".__("'Add Book'",'wpbooklist')." </span>".__("button. If you choose to gather book info from Amazon,",'wpbooklist')."  <span class='wpbooklist-color-orange-italic'>".__("the only required field is the ISBN/ASIN number",'wpbooklist')."</span>.<br/><br/><span ";
