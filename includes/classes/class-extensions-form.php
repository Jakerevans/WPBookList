...
if ( ! class_exists( 'WPBookList_Add_Book_Form', false ) ) :
	...
	class WPBookList_Add_Book_Form {
		...
		public static function output_add_book_form() {
			...
			<p class="wpbooklist-tab-intro-para">'.__('Extensions are the easiest way to add additional functionality to your','wpbooklist').'<span class="wpbooklist-color-orange-italic">WPBookList</span> '.__('plugin. Simply purchase the extension of your choice and install it just like you’d install any other WordPress plugin. That’s all there is to it!','wpbooklist').'<br/><br/>
			...
			<img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/book.svg"><img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/ereader-with-bookmark.svg"><img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/profits.svg"><p class="wpbooklist-tab-intro-para"></p>
			<p class="wpbooklist-extension-p-bundle-ext">'.__('Extensions Bundle!','wpbooklist').'</p>
			<p class="wpbooklist-tab-intro-para"><img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/server.svg"><img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/ereader.svg"><img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/goodreads-letter-logo.svg">
					 </p>
			</div>
			</a>
			...
			<img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/goodreads-letter-logo.svg"><p class="wpbooklist-tab-intro-para"></p>
			<p class="wpbooklist-extension-p-bundle-ext">TimeSaver Bundle!</p>
			<p class="wpbooklist-tab-intro-para"><img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/server.svg"><img class="wpbooklist-extension-img-bundle-mult" src="http://wpbooklist.com/wp-content/uploads/2017/08/svgs/ereader.svg">
				   </p>
			</div>
			</a>
			...
			<p class="wpbooklist-extension-excerpt"><span class="wpbooklist-excerpt-span">'.__('Let your visitors add books with the','wpbooklist').' <span class="wpbooklist-color-orange-italic">'.__('WPBookList BookFinder Extension!','wpbooklist').'</span></span><span class="wpbooklist-top-line-span"></span></p>
			<div class="wpbooklist-above-purchase-line"></div>
			...
			<p class="wpbooklist-extension-excerpt"><span class="wpbooklist-excerpt-span">'.__('Add some Movement! Provides another way to creatively display your books!','wpbooklist').' </span><span class="wpbooklist-top-line-span"></span></p>
			<div class="wpbooklist-above-purchase-line"></div>
